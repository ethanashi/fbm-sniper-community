...
export const MERCADOLIBRE_DATA_DIR = path.join(DATA_DIR, "mercadolibre");
export const MERCADOLIBRE_FOUND_FILE = path.join(MERCADOLIBRE_DATA_DIR, "found.ndjson");
export const MERCADOLIBRE_SEEN_FILE = path.join(MERCADOLIBRE_DATA_DIR, "seen_ids.json");

export const AMAZON_DATA_DIR = path.join(DATA_DIR, "amazon");
export const AMAZON_FOUND_FILE = path.join(AMAZON_DATA_DIR, "found.ndjson");
export const AMAZON_SEEN_FILE = path.join(AMAZON_DATA_DIR, "seen_ids.json");
