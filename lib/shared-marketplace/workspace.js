...
const DEFAULT_BOTS = {
  facebook: {
    pollIntervalSec: 90,
    // GraphQL persisted-query overrides for the Facebook scraper.
    // Pasted in the Settings tab. Sanitized at use-time by fb-config.js.
    searchDocId: "",
    detailDocId: "",
    // Full POST body or `variables=...` blob captured from a logged-in
    // browser request — needed when FB's persisted query schema requires
    // variables our anon scraper can't synthesize.
    searchVariables: "",
    detailVariables: "",
  },
