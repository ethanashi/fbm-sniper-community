#!/bin/bash
# update.sh — Pull latest code, rebuild image, and restart container
# Usage: ./update.sh [DOCKER_HOST]
#
# Examples:
#   ./update.sh                          # Local Docker
#   ./update.sh tcp://10.1.1.122:2375   # Remote Docker on VM
